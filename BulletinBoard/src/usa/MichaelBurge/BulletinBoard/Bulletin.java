...
public class Bulletin implements Comparable<Bulletin> {
	...
	public static Bulletin CreateItemBulletin(String ownerName,int value, int postingFee, int acceptFee, int itemType, short itemDamage, int itemAmount, String message, boolean isBuy)
	{
		Bulletin ret = new Bulletin();
	...
	public void setItemData(short itemDamage) {
